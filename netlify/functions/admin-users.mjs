...
export default async (req) => {
  ...
  try {
    ...
    if (req.method === 'PATCH' || req.method === 'POST') {
      ...
      return json({
        ok: true,
        user: { id: updated.id, email: updated.email || '', roles: Array.isArray(updated.roles) ? updated.roles : [role] },
        note: 'D Rolle wird nach em nächste Login oder Token-Refresh aktiv.',
      });
    }
