...
// Zusätzliche /home/-Fallbacksite, falls en alte Link no /home/ nutzt.
fs.mkdirSync(path.join(dist, 'home'), { recursive: true });
fs.copyFileSync(path.join(src, 'index.html'), path.join(dist, 'home', 'index.html'));
...
const requiredPages = [
  'index.html', 'home/index.html', 'login/index.html', 'schueler/index.html',
